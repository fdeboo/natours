...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmRlYm9vIiwiYSI6ImNrc3VxOHM3NDFpY3Qyd29kOTFzMnlsb2kifQ.ptPFv8SFS0_qM0HaVFGKhw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type[0].toUpperCase()).concat(type.slice(1), " updated successfully!"));
            }
...
var stripe = Stripe('pk_test_51JU5UgK0w9DC3f48JRP4NwSGBjj3lLYOSRwqpKAwKSaw2HaY9t0EJzlPRnhUPUWDwCZnokgBHCB948z1VY7EOxHK003tLhwpCh');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ev) {
      var passwordCurrent, password, passwordConfirm, email;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (ev) {
    ...
    var tourId = ev.target.dataset.tourId;
